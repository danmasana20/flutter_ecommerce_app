...
class AppData {
  static List<Product> productList = [
    Product(
        ...
        price: 240.00,
        isSelected: true,
        isLiked: false, // Corrected 'isliked' to 'isLiked'
  ...
  static List<Category> categoryList = [
    // Default Category with no information
    Category(id: 0, name: "Default", image: "", isSelected: false),
    ...
    Category(id: 4, name: "Accessories", image: 'assets/watch.png'),
  ];
